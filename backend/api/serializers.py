...
from .models import (
    ...
    Produto,
    Cliente,
    SceMovimentacaoEstoque,
    SceMovimentacaoEstoqueItem,
    SceAlmoxarifado,
    SceTipoMovimentacaoEstoque
)
...
class SceAlmoxarifadoSerializer(serializers.ModelSerializer):
    class Meta:
        model = SceAlmoxarifado
        fields = "__all__"


class SceTipoMovimentacaoEstoqueSerializer(serializers.ModelSerializer):
    class Meta:
        model = SceTipoMovimentacaoEstoque
        fields = "__all__"